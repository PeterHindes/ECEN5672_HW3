...
model = Sequential([
    # Encoder
    layers.Conv2D(64, (3, 3), padding='same', activation='leaky_relu', input_shape=(28, 28, 1)),
    ...
    layers.Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same', activation='leaky_relu'),  # 7→14
    layers.Conv2DTranspose(32, (3, 3), strides=(2, 2), padding='same', activation='leaky_relu'),  # 14→28
